		...
		<div class="content-area-inner" style="padding-top:40px;">
			...
			<div class="dev-main eclipse-main">
				<div class="eclipse-main-container">	
					...
					<p><a target="_blank" href="http://demo.actuate.com/demos/EclipseDemo/EclipseDemo.html">BIRT Demo</a> - This demonstration is a Flash presentation of BIRT that showcases some of its powerful features including summary and line graphs, JavaScript for dynamic images, style usage, highlighting, grouping and detail drill down..</p>
					...
					<ul class="eclipse-list">
						<li><strong>Aggregate Function Extension Point</strong> (<a href="http://www.eclipse.org/birt/phoenix/examples/extending/aggregate/optim.rptdesign" target="_blank">rptdesign</a> | <a href="http://www.eclipse.org/birt/phoenix/examples/extending/aggregate/optimiticSum.zip" target="_blank">Java code</a> | <a href="http://demo.actuate.com/demos/extensions/aggregatefunction/aggregate.html" target="_blank">demo</a>) - This example shows how to create a BIRT Aggregate Data Extension. Imagine your manager wants you to create a new more optimistic way to sum up data in a report. Is there a way that you can create a common solution that can be consistently re-used across all of your reports? Through the Birt Aggregate Data Extension you can create new custom functions that show up as native BIRT functions.</li><br />
					</ul>
					</p>
