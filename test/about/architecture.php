		...
		<div class="content-area-inner" style="padding-top:40px;">
			...
			<div class="dev-main eclipse-main">
				<div class="eclipse-main-container">	
					...
					<p>The BIRT project delivers many components. These are listed below with a brief description. More information about BIRT components and architecture is available in the <a href="/birt/test/documentation/">documentation</a> section.
