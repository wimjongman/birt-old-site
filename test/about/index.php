		...
		<div class="content-area-inner" style="padding-top:40px;">
			...
			<div class="dev-main eclipse-main">
				<div class="eclipse-main-container">	
					...
					<a href="architecture.php" target="_blank">Learn more about BIRT Architecture</a>
					...
					<a href="birt-and-actuate.php" target="_blank">Learn more about Actuate's BIRT-based product line</a></p>
