		...
		<div class="content-area-inner" style="padding-top:40px;">
			...
			<div class="dev-main eclipse-main">
				<div class="eclipse-main-container">	
					...
					<a style="font-size:14px" href="project-organization.php">Project Organization</a> | <a style="font-size:14px" href="project-plan.php">Project Development Plan</a>
					...
					<a style="font-size:14px" href="http://www.actuate.com/partners/birt-adopters/" target="_blank">See a list of BIRT Adopters</a>
					...
					<a style="font-size:14px" href="architecture.php" target="_blank">Learn more about BIRT Architecture</a>
					...
					<a style="font-size:14px" href="birt-and-actuate.php" target="_blank">Learn more about Actuate's BIRT-based product line</a></p>
