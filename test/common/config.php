...
<li><a href="/org/foundation/contact.php">Contact Us</a></li></ul></div>
			<div style="display:inline;"><span style="display:block;">Copyright &copy; 2014 The Eclipse Foundation. All Rights Reserved.</span>
			<img style="width:200px; display:block; padding-top:20px;" src="/eclipse.org-common/themes/Nova/images/eclipse-800x426.png" />
			</div>
		<!-- Footer End -->';
		return $footer;
	}
