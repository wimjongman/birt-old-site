				...
				<div class="eclipse-main-container">	
					<div class="eclipse-home-banner">
						...
						<div class="eclipse-home-banner-inner" style="padding-top:110px;">
							...
							<div style="margin-left: 249px;margin-right: 20px;"><table><tbody><tr><td><a href="#" class="square-button button-color-yellow" style="margin-right:15px;padding:10 30px;line-height:22px;">Download<br />BIRT 4.3.2</a></td><td>  
							<a href="#" class="square-button button-color-yellow" style="padding:10 30px;line-height:22px;">Download Actuate<br />Supported Version</a></td></tr></tbody></table></div>
						</div>
					</div>
				</div>
			</div>
