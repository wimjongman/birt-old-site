				...
				<div class="eclipse-main-container">	
					<div class="eclipse-home-banner">
						...
						<div class="eclipse-home-banner-inner" style="padding-top:110px;">
							...
							<a href="<?php $basePath ?>/about/birt-and-actuate.php" class="square-button button-color-yellow" style="padding:10 30px;line-height:22px;">Download Actuate<br />Supported Version</a></td></tr></tbody></table></div>
						</div>
					</div>
				</div>
			</div>
