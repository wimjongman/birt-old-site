				...
				<div class="eclipse-main-container">	
					<div class="eclipse-home-banner">
						...
						<div class="eclipse-home-banner-inner" style="padding-top:110px;">
							...
							<div style="margin-left: 249px;margin-right: 20px;"><table><tbody><tr><td><a href="#" class="square-button button-color-yellow" style="margin-right:15px;padding:0 12px;bottom-border:none;">Download</a><a href="#" class="square-button button-color-yellow" style="margin-right:15px;padding:0 12px;bottom-top:none;">BIRT 4.3.2</a></td><td>  
