		...
		<div class="content-area-inner" style="padding-top:40px;">
			...
			<div class="dev-main eclipse-main">
				<div class="eclipse-main-container">	
					...
					<img src="/birt/img/documentation/integrating/overview.jpg" /><br/><br/>
					...
					<img src="/birt/img/documentation/integrating/events.jpg" />
					...
					Generation phase.</p>
					<img src="/birt/img/documentation/integrating/eventgen.jpg" />
					<p>Presentation phase.</p>
					<img src="/birt/img/documentation/integrating/eventpres.jpg" />
					...
					<img src="/birt/img/documentation/integrating/palette.jpg"/>
					...
					<p><img src="/birt/img/documentation/integrating/getStyle.jpg" />
					</p>
					...
					<img src="/birt/img/documentation/integrating/buildpath.jpg" /><br/><br/>
					
					<p>The scriptapi.jar file includes the event adapters that are needed to implement event handlers.</p>
					
					<img src="/birt/img/documentation/integrating/eventadapters.jpg" /><br/><br/>
					
					<p>Create a new class, specifying TableEventAdapter as the super class.</p>
					<img src="/birt/img/documentation/integrating/tableadapter.jpg" /><br/><br/>
					...
					<img src="/birt/img/documentation/integrating/tableeh.jpg" /><br/><br/>
					...
					<img src="/birt/img/documentation/integrating/scriptoutput.jpg" />
					...
					<img src="/birt/img/documentation/integrating/debugjava.png" />
					...
					<img src="/birt/img/documentation/integrating/debugjs.png" />
