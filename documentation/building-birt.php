				...
				<div class="eclipse-main-container">	
					...
					<ul class="eclipse-list">
						...
						<li>On Source compatibility, select 1.4.<br /><br />
							...
							<img src="/birt/img/documentation/building-birt/compliancepreference.jpg" />
						</li><br />
						<li>Choose OK.</li>
					</ul>
					</p>
  ...
  <tr>
   ...
   <td>The BIRT feature</td>
					...
					<ul class="eclipse-list">
						...
						<img src="/birt/img/documentation/building-birt/selectperspective.jpg" /></li><br />
						<li>Right-click on the CVS repositories window. From the context menu, choose New -> Repository Location.<br /><br />
						<img src="/birt/img/documentation/building-birt/newrepository.jpg" /></li><br />
						...
						<img src="/birt/img/documentation/building-birt/addcvsrepository.jpg" /></li><br />
						<li>Choose Finish</li>
					</ul>
					...
					<ul class="eclipse-list">						
						...
						<img src="/birt/img/documentation/building-birt/projects.jpg" /></li><br />
					...
					<img src="/birt/img/documentation/building-birt/itext.jpg" /><br /><br />
					...
					<ul class="eclipse-list">
						...
						<img src="/birt/img/documentation/building-birt/antbuild.jpg" /></li><br />
						...
						<img src="/birt/img/documentation/building-birt/eclipsehome.jpg" /></li><br />
					...
					<ul class="eclipse-list">
						...
						<img src="/birt/img/documentation/building-birt/runconfig1.jpg" /></li><br />
						...
						<img src="/birt/img/documentation/building-birt/runconfig2.jpg" /></li>
					</ul>
					</p>
					...
					<ul class="eclipse-list">
						...
						<li>click on Run --> Run --> Double click on JUnit Plug-in Test , this will create a new configuration. In the window, you can select among different options.<br /><br />
							...
							<img src="/birt/img/documentation/building-birt/runcreateconfig.jpg" /><br /><br />
							...
							<img src="/birt/img/documentation/building-birt/runtests75.jpg" /><br /><br />
