		...
		<div class="content-area-inner" style="padding-top:40px;">
			...
			<div class="dev-main eclipse-main">
				<div class="eclipse-main-container">	
					...
					<p>BIRT uses Java formatting for dates, numbers and strings. In addition, BIRT adds a number of specialized, locale-aware date formats described in the <a href="/birt/resources/documentation/ROM_Styles_SPEC.pdf" target="_blank">ROM Styles Specification</a>.</p>
