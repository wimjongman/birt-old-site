<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "BIRT 2.2.2 Project Plan";
	$pageKeywords	= "";
	$pageAuthor		= "";
...
<p class="head">BIRT Project 2.2.2 Plan</p>





<p>Last revised December 14, 2007</p>
...
feature
release of the Eclipse BIRT project after 2.2.1, designated release
2.2.2.</p>
...
<ul>
  ...
  <li><font face="Times New Roman" size="3"><span style="font-size: 12pt;">Final Release 
Candidate - Week of January 7, 2008 </span></font></li>
...
<p>The Eclipse BIRT 2.2.2 release depends on the following
compatibility
stack:</p>
...
<p><b>BIRT 2.2.2 Reference Stack for JDK 1.4.2</b></p>
...
<p><b>BIRT 2.2.2 Reference Stack for JDK 1.5</b></p>
...
<p>For BIRT 2.2.2, the project team plans to tests and validate
the following
...
BIRT Report Framework 2.2.2 and Eclipse BIRT RCP Report Designer 2.2.2
...
<table border="1">
  ...
  <tbody>
    ...
    <tr bgcolor="#cccccc">
      ...
      <div align="center"> <b><font size="+1">Eclipse
BIRT Runtime 2.2.2 and Eclipse BIRT Charts 2.2.2 Reference Platforms</font></b></div>
...
<h2><span style="font-weight: bold;"><a name="CommunityOperatingEnvironments" id="CommunityOperatingEnvironments">
Community
...
environments for the 2.2.2 release of BIRT and to share this
...
minutes to update this <a href="http://wiki.eclipse.org/BIRT_Community_Tested_Operating_Environments_for_2.2.2">wiki
...
<p>BIRT 2.2.2 will be compatible with earlier versions of BIRT to
the greatest
extent possible. The nature and scope of some of the key plan items for
BIRT 2.2.2 are such that the only feasible solutions might break
compatibility. In
other regards, BIRT 2.2.2 will be compatible with 2.x and 1.x. We also
aim to
minimize the effort required to port an existing plug-in to the 2.2.2
APIs.</p>
...
<h3>Compatibility of Release 2.2.2 with 2.2.1, 2.2, 2.1.x, 2.1,
2.0.x and 1.x</h3>
...
<p>BIRT 2.2.2 will be compatible with BIRT 2.2.1, 2.2, 2.1,
2.1.x, 2.0.x and
1.x unless
...
<p><b>API Contract Compatibility:</b> BIRT 2.2.2 will
be upwards
contract-compatible with BIRT 2.2.1, 2.2, 2.1, 2.1.x, 2.0.x and
1.x
to the greatest
...
compliance with BIRT 2.2.2 APIs will ensure compliance with BIRT 2.2.1,
2.2,
2.1,
2.1.x,
...
<p>The BIRT Chart UI API&nbsp;2.2.2 is compatible with the
2.2.1, 2.2, 2.1, 2.1.x, 2.0.x API
...
2.2.2 plug-in framework will
be upwards binary-compatible with BIRT 2.2.1, 2.2, 2.1, 2.1.x,
2.0.x
and 1.x
plug-ins to
the greatest extent possible. Downward plug-in compatibility is not
supported. Plug-ins for BIRT 2.2.2 will not be usable in BIRT 2.2.1,
2.2, 2.1,
2.1.x, 2.0.x
or 1.x. Extension plug-ins for BIRT 2.2.1, 2.2, 2.1, 2.1.x,
2.0.x and
1.x will be
upwards
binary-compatible with BIRT 2.2.2.</p>





<p><b>Source Compatibility:</b> BIRT 2.2.2 will be
upwards source-compatible
with BIRT 2.2.1, 2.2, 2.1, 2.1.x, 2.0.x and 1.x to the greatest
extent possible.
This
means that source files written to use BIRT 2.2.1, 2.2, 2.1, 2.1.x,
2.0.x or 1.x
APIs
will successfully compile and run against BIRT 2.2.2 APIs. Downward
source
...
<p><b>Report Design Compatibility:</b>BIRT 2.2.2 will
be upwards report design
compatible with BIRT 2.2.1, 2.2, 2.1, 2.1.x, 2.0.x and 1.x
unless
noted. This means
that
reports created with BIRT 2.2.1, 2.2, 2.1, 2.1.x, 2.0.x or 1.x
can be
successfully
opened
by BIRT 2.2.2 and upgraded to a 2.2.2 format.</p>
...
<p>BIRT 2.2.2 is the second maintenance release in the BIRT 2.2 release
series and is intended to be narrow in scope. The 2.2.2 release is
focused on addressing critical bugs identified by the community. <br>
...
No new features are planned for this release.<br>
...
BIRT 2.2.2 will address defects reported by project members and the
community. The <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced&amp;short_desc_type=allwordssubstr&amp;short_desc=&amp;classification=BIRT&amp;product=BIRT&amp;target_milestone=2.2.2&amp;long_desc_type=allwordssubstr&amp;long_desc=&amp;bug_file_loc_type=allwordssubstr&amp;bug_file_loc=&amp;status_whiteboard_type=allwordssubstr&amp;status_whiteboard=&amp;keywords_type=allwords&amp;keywords=&amp;resolution=FIXED&amp;emailtype1=substring&amp;email1=&amp;emailtype2=substring&amp;email2=&amp;bugidtype=include&amp;bug_id=&amp;votes=&amp;chfieldfrom=&amp;chfieldto=Now&amp;chfieldvalue=&amp;cmdtype=doit&amp;order=Reuse+same+sort+as+last+time&amp;field0-0-0=noop&amp;type0-0-0=noop&amp;value0-0-0=">list
of defects</a> targeted for resolution in BIRT 2.2.2 can be found
