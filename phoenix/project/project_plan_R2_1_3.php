<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "BIRT 2.1.3 Project Plan";
	$pageKeywords	= "";
	$pageAuthor		= "";
...
<body>
<p class="head">BIRT Project 2.1.3 Plan</p>
...
maintenance
release of the Eclipse BIRT project after 2.1.2, designated release
2.1.3.</p>
...
<p>The Eclipse BIRT 2.1.3 release depends on the following
compatibility
stack:</p>

<p><b>BIRT 2.1.3 Reference Stack for Eclipse 3.2</b></p>
...
<p>For BIRT 2.1.3, the project team plans to tests and validate
the following
...
BIRT Report Framework 2.1.3 and Eclipse BIRT RCP Report Designer 2.1.3
...
<table border="1">
  ...
  <tbody>
    ...
    <tr bgcolor="#cccccc">
      ...
      <th colspan="4">
      <div align="center"> <b><font size="+1">Eclipse
BIRT Runtime 2.1.3 and Eclipse BIRT Charts 2.1.3 Reference Platforms</font></b></div>
...
1.4.2, version 5.0</td>
    ...
    <tr>
      ...
      <td width="205">Microsoft Windows
Serverhttp://wiki.eclipse.org/index.php/Europa_Simultaneous_Release 2003</td>
...
dialhttp://wiki.eclipse.org/index.php/Europa_Simultaneous_Releaseogs
and error messages, are externalized. The English strings for
BIRT
...
<p>BIRT 2.1.3 will be compatible with earlier versions of BIRT to
the
greatest extent possible. The nature and scope of some of the key plan
items
for BIRT 2.1.3 are such that the only feasible solutions might break
compatibility. In other regards, BIRT 2.1.3 will be compatible with
2.1.2, 2.1.1, 2.1, 2.0
and 1.x. We also aim to minimize the effort required to port an
existing
plug-in to the 2.1.3 APIs.</p>

<h3>Compatibility of Release 2.1.3 with 2.0 and 1.x</h3>

<p>BIRT 2.1.3 will be compatible with BIRT 2.1.2, 2.1.1, 2.1, 2.0
and
...
<p><b>API Contract Compatibility:</b> BIRT 2.1.3 will
be upwards
contract-compatible with BIRT 2.1.2, 2.1.1, 2.1, 2.0 and 1.x to the
greatest
extent
possible. All incompatibility exceptions will be documented. Downward
contract compatibility is not supported. There is no guarantee that
compliance with BIRT 2.1.3 APIs will ensure compliance with BIRT 2.1.2,
2.1.1,
2.1, 2.0 or
1.x APIs. Refer to general Eclipse document on <a href="http://wiki.eclipse.org/index.php/Evolving_Java-based_APIs">Evolving
APIs</a> for a discussion of the kinds of API changes that
maintain contract
compatibility.</p>

<p>The BIRT Chart UI API v2.1.3 is compatible with the v2.1, v2.0
API but not
...
2.1.3 plug-in framework
will be upwards binary-compatible with BIRT 2.1.2, 2.1.1, 2.1, 2.0 and
1.x
plug-ins to the
greatest extent possible. Downward plug-in compatibility is not
supported.
Plug-ins for BIRT 2.1.3 will not be usable in BIRT 2.0 or 1.x.
Extension
plug-ins for BIRT 2.0 and 1.x will be upwards binary-compatible with
BIRT
2.1.3.</p>

<p><b>Source Compatibility:</b> BIRT 2.1.3 will be
upwards source-compatible
with BIRT 2.1.2, 2.1.1, 2.1, 2.0 and 1.x to the greatest extent
possible. This means
that
source files written to use BIRT 2.1.2, 2.1.1, 2.1, 2.0 or 1.x APIs
will
successfully
compile and run against BIRT 2.1.3 APIs. Downward source compatibility
is not
supported. If source files use new BIRT APIs, they will not be usable
with an
earlier version of BIRT.</p>

<p><b>Report Design Compatibility:</b>BIRT 2.1.3 will
be upwards report
design compatible with BIRT 2.1.2, 2.1.1, 2.1, 2.0 and 1.x unless
noted. This
means that
reports created with BIRT 2.1.2, 2.1.1, 2.1, 2.0 or 1.x can be
successfully
opened by BIRT
2.1.3 and upgraded to a 2.1.3 format.</p>
...
<p>
This release is primarily aimed at addressing identified serious bugs
in BIRT 2.1.2.
</p>
...
<ul>
  ...
  <li>Support for WebSphere Application Server 6.1 [Bugzilla ID: <a href="https://bugs.eclipse.org/bugs/show_bug.cgi?id=165924">165924</a>]
  </li>

  <li>Improvements in PDF support [Bugzilla ID: [<a href="https://bugs.eclipse.org/bugs/buglist.cgi?quicksearch=168130%2C168131%2C168132%2C168133%2C168134%2C168135%2C168136%2C168137">168130
- 168137</a>] </li>

  <li>Packaging of iText Library [Bugzilla ID: <a href="https://bugs.eclipse.org/bugs/show_bug.cgi?id=142750">142750</a>]</li>

</ul>

<h2><a name="Defects" id="Defects">Defects</a></h2>

BIRT 2.1.3 will address defects reported by project members and the
...
of defects</a> targeted for resolution in BIRT 2.1.3 can be found
