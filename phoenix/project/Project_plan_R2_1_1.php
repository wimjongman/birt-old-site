...
<body>
<p class="head">BIRT Project 2.1.1 Plan</p>

<p>Last revised August 28, 2006</p>

<h2><a name="Introduction" id="Introduction"></a>Introduction</h2>

<p>This document lays out the feature and API set for the next feature
release of the Eclipse BIRT project after 2.1, designated release 2.1.1.</p>
<ul>
...
<ul>
  <li>Friday, September 29, 2006 BIRT 2.1.1 Maintenance Release available</li>
</ul>

<p>Our target is to complete and release BIRT 2.1.1 with the Callisto
Coordinated Maintenance release, currently targeted for 9/29/2006.</p>
...
<p>The Eclipse BIRT 2.1.1 release depends on the following compatibility
stack:</p>

<p><b>BIRT 2.1.1 Reference Stack for Eclipse 3.2</b></p>
<ul>
...
<p>For BIRT 2.1.1, the project team plans to tests and validate the following
...
<table border="1">
  <tbody>
    <tr bgcolor="#CCCCCC">
      <th colspan="4">
        <div align="center">
        <b><font size="+1">Eclipse BIRT Report Framework 2.1.1 and Eclipse
        BIRT RCP Report Designer 2.1.1 Reference Platforms</font></b></div>
      </th>
    </tr>
    <tr>
...
<table border="1">
  <tbody>
    <tr bgcolor="#CCCCCC">
      <th colspan="4">
        <div align="center">
        <b><font size="+1">Eclipse BIRT Runtime 2.1.1 and Eclipse BIRT Charts
        2.1.1 Reference Platforms</font></b></div>
      </th>
    </tr>
    <tr>
      <td width="205"><b>Operating system</b></td>
...
<p>BIRT 2.1.1 will be compatible with earlier versions of BIRT to the
greatest extent possible. The nature and scope of some of the key plan items
for BIRT 2.1.1 are such that the only feasible solutions might break
compatibility. In other regards, BIRT 2.1.1 will be compatible with 2.0 and
1.x. We also aim to minimize the effort required to port an existing plug-in
to the 2.1.1 APIs.</p>

<h3>Compatibility of Release 2.1.1 with 2.0 and 1.x</h3>

<p>BIRT 2.1.1 will be compatible with BIRT 2.0 and 1.x unless noted. The
...
<p><b>API Contract Compatibility:</b> BIRT 2.1.1 will be upwards
...
BIRT 2.1.1 APIs will ensure compliance with BIRT 2.0 or 1.x APIs. Refer to
...
<p>The BIRT Chart UI API v2.1.1 is compatible with the v2.0 API but not
compatible with the v1.x APIs due to a full redesign of the Chart UI in the
BIRT 2.0 release.</p>

<p><b>Binary (plug-in) Compatibility:</b> The BIRT 2.1.1 plug-in framework
...
Plug-ins for BIRT 2.1.1 will not be usable in BIRT 2.0 or 1.x. Extension
plug-ins for BIRT 2.0 and 1.x will be upwards binary-compatible with BIRT
2.1.1.</p>

<p><b>Source Compatibility:</b> BIRT 2.1.1 will be upwards source-compatible
...
against BIRT 2.1.1 APIs. Downward source compatibility is not supported. If
source files use new BIRT APIs, they will not be usable with an earlier
version of BIRT.</p>

<p><b>Report Design Compatibility:</b>BIRT 2.1.1 will be upwards report
design compatible with BIRT 2.0 and 1.x unless noted. This means that reports
created with BIRT 2.0 or 1.x can be successfully opened by BIRT 2.1.1 and
upgraded to a 2.1.1 format.</p>
...
overriding release 2.1.1 theme remains extending the Eclipse platform to
...
<ul>
  <li>BIRT 2.1.1 will address defects reported by project members and the
    community. The <a
    ...
    of defects</a> targeted for resolution in BIRT 2.1.1 can be found in the
    bugzilla database on <a
    href="https://bugs.eclipse.org/bugs">https://bugs.eclipse.org/bugs</a>.</li>
</ul>
</body>
<br>
<br>
