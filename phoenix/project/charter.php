...
Header("Location: /birt/about/project-organization/charter.php");																									require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'

	#
	# Begin: page-specific settings.  Change these.
	$pageTitle 		= "BIRT Project Charter";
	$pageKeywords	= "";
	$pageAuthor		= "";
	...
	<div id="midcolumn">
		...
		<blockquote>
			<ul>
				...
				<li><a href="#pmc">Project Management Committee</a></li>
				<li><a href="#requirements_group">Project Requirements Group</a></li>
				<li><a href="#architecture_group">Project Architecture Group</a></li>
				<li><a href="#planning_group">Project Planning Group</a></li>
				<li><a href="#roles">Roles</a></li>
				<li><a href="#projects">Projects</a></li>
				<li><a href="#project_components">Project Components</a></li>
				<li><a href="#ports">Ports</a></li>
				<li><a href="#cycles">Coordinated Release Cycles</a></li>
				<li><a href="#infrastructure">Infrastructure</a></li>
				<li><a href="#dev_process">The Development Process</a></li>
		...
		<ul class="midlist">
			<li>
				<b>Bug Database</b> -
				Bugzilla-like database for tracking bugs and feature requests.
			</li>
			<li>
				<b>Source Repository</b> -
				One or more CVS repositories containing both the master source code and documentation for the projects.
			</li>
			<li>
				<b>Website</b> -
				A Web site will contain information about the project, including documentation, downloads of releases, and this charter.
			</li>
			<li>
				<b>General Mailing List</b> -
				Mailing list for development discussions pertaining to the project as a whole or that cross projects. This mailing list is open to the public.
			</li>
			<li>
				<b>Project Mailing Lists</b> -
				Development mailing list for technical discussions and committer voting related to the project. These mailing lists are open to the public.
			</li>
			<li>
				<b>Component Mailing Lists</b> -
				Development mailing list for technical discussions and committer voting related to the component. This mailing list is open to the public.
			</li>
			<li>
				<b>Newsgroup</b> -
