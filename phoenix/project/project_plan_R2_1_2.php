<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "BIRT 2.1.2 Project Plan";
	$pageKeywords	= "";
	$pageAuthor		= "";
...
<body>
<p class="head">BIRT Project 2.1.2 Plan</p>

<p>Last revised November 6, 2006</p>

<h2><a name="Introduction" id="Introduction"></a>Introduction</h2>

<p>This document lays out the feature and API set for the next feature
release of the Eclipse BIRT project after 2.1, designated release 2.1.2.</p>
<ul>
...
<p>This maintenance release of BIRT will focus on providing the same
downloads as BIRT 2.1.</p>

<h2><a name="Milestones" id="Milestones"></a>Release milestones</h2>
<ul>
  <li>Friday, February 16, 2007 BIRT 2.1.2 Maintenance Release available</li>
</ul>

<p>Our target is to complete and release BIRT 2.1.2 with the Callisto
Coordinated Maintenance release, currently targeted for 2/16/2007.</p>
...
<p>The Eclipse BIRT 2.1.2 release depends on the following compatibility
stack:</p>

<p><b>BIRT 2.1.2 Reference Stack for Eclipse 3.2</b></p>
<ul>
...
<p>For BIRT 2.1.2, the project team plans to tests and validate the following
...
<table border="1">
  <tbody>
    <tr bgcolor="#CCCCCC">
      <th colspan="4">
        <div align="center">
        <b><font size="+1">Eclipse BIRT Report Framework 2.1.2 and Eclipse
        BIRT RCP Report Designer 2.1.2 Reference Platforms</font></b></div>
      </th>
    </tr>
    <tr>
...
<table border="1">
  <tbody>
    <tr bgcolor="#CCCCCC">
      <th colspan="4">
        <div align="center">
        <b><font size="+1">Eclipse BIRT Runtime 2.1.2 and Eclipse BIRT Charts
        2.1.2 Reference Platforms</font></b></div>
      </th>
    </tr>
    <tr>
      <td width="205"><b>Operating system</b></td>
...
<p>BIRT 2.1.2 will be compatible with earlier versions of BIRT to the
greatest extent possible. The nature and scope of some of the key plan items
for BIRT 2.1.2 are such that the only feasible solutions might break
compatibility. In other regards, BIRT 2.1.2 will be compatible with 2.1.1, 2.1, 2.0
and 1.x. We also aim to minimize the effort required to port an existing
plug-in to the 2.1.2 APIs.</p>

<h3>Compatibility of Release 2.1.2 with 2.0 and 1.x</h3>

<p>BIRT 2.1.2 will be compatible with BIRT 2.1.1, 2.1, 2.0 and 1.x unless noted. The
...
<p><b>API Contract Compatibility:</b> BIRT 2.1.2 will be upwards
contract-compatible with BIRT 2.1.1, 2.1, 2.0 and 1.x to the greatest extent
...
compliance with BIRT 2.1.2 APIs will ensure compliance with BIRT 2.1.1, 2.1, 2.0 or
1.x APIs. Refer to general Eclipse document on <a
...
<p>The BIRT Chart UI API v2.1.2 is compatible with the v2.1, v2.0 API but not
compatible with the v1.x APIs due to a full redesign of the Chart UI in the
BIRT 2.0 release.</p>

<p><b>Binary (plug-in) Compatibility:</b> The BIRT 2.1.2 plug-in framework
will be upwards binary-compatible with BIRT 2.1.1, 2.1, 2.0 and 1.x plug-ins to the
greatest extent possible. Downward plug-in compatibility is not supported.
Plug-ins for BIRT 2.1.2 will not be usable in BIRT 2.0 or 1.x. Extension
plug-ins for BIRT 2.0 and 1.x will be upwards binary-compatible with BIRT
2.1.2.</p>

<p><b>Source Compatibility:</b> BIRT 2.1.2 will be upwards source-compatible
with BIRT 2.1, 2.0 and 1.x to the greatest extent possible. This means that
source files written to use BIRT 2.1.1, 2.1, 2.0 or 1.x APIs will successfully
compile and run against BIRT 2.1.2 APIs. Downward source compatibility is not
supported. If source files use new BIRT APIs, they will not be usable with an
earlier version of BIRT.</p>

<p><b>Report Design Compatibility:</b>BIRT 2.1.2 will be upwards report
design compatible with BIRT 2.1.1, 2.1, 2.0 and 1.x unless noted. This means that
reports created with BIRT 2.1.1, 2.1, 2.0 or 1.x can be successfully opened by BIRT
2.1.2 and upgraded to a 2.1.2 format.</p>
...
<p>
This release is primarily aimed at addressing identified serious bugs in BIRT 2.1 and BIRT 2.1.1.
</p>

<h2><a name="Projects" id="Projects">Projects</a></h2>
BIRT 2.1.2 will address defects reported by project members and the
    community. The <a
    ...
    of defects</a> targeted for resolution in BIRT 2.1.2 can be found in the
    bugzilla database on <a
    href="https://bugs.eclipse.org/bugs">https://bugs.eclipse.org/bugs</a>.
</body>
<br>
<br>
EOHTML;
