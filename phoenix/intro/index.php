...
<div id="maincontent">
	<div id="midcolumn">
		...
		<p></p>
		<p>
			The current released version is 1.0.1. We encourage you to download
		...
		<ul class="midlist">
			...
			<li>
				...
				in Release 1.0.1, but are planned for a future release.)
			</li>
			<li>
				Letters &amp; Documents -
		...
		<ul class="midlist">
			<li>
				...
				Release 1.0.1 provides JDBC support, as well as support for using code to get at
