...
Header("Location: /birt/documentation/integrating/viewer-usage.php");																										require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		...
		<blockquote>
			...
			<ul>
				...
				<li><a href="#servlets">Servlet Mappings</a></li>
				<li><a href="#webxml">Web Viewer Web.xml Settings</a></li>
				<li><a href="#parameters">Parameters</a></li>
				<li><a href="#directory">Viewer Directory Structure</a></li>
				<li><a href="#tags">Viewer Tag Library</a></li>
			</ul>
		</blockquote>
...
<p >The Web Viewer can be used to
generate and render reports, and also supports more interactive features such
as table of contents, exporting report content to several formats, client and
server side printing, as well as report pagination. The features available
will depend on what servlet mapping is used, the settings available in the
web.xml file and what values are passed as parameters.</p>

<p >The Example Viewer
can also be deployed as an Eclipse plugin in an RCP application.</p>

<p >The
Example Viewer also ships with a tag library which can be used to provide
report functionality within your existing web applications.</p>

<h2><a name="servlets"></a>Servlet Mappings</h2>
<p>
The BIRT Web Viewer consist of two main Servlets, the ViewerServlet and the BirtEngineServlet.  
These Servlets handle three mappings: ( /frameset, /run, and /preview).
</p>
<p>
The <b>/frameset</b> mapping renders the report in the full AJAX viewer complete with toolbar, navigation bar and table of contents features.  This mapping also generates an intermediate report document from the report design file to support the AJAX based features.  
<br>eg http://localhost:8080/viewer/frameset?__report=myreport.rptdesign&parm1=value1
</p>
<p>
The <b>/run</b> mapping runs and renders the report but does not create a report document.   This mapping does not supply HTML pagination, TOC or toolbar features, but does use the AJAX framework to collect parameters, support report cancelling and retrieve the report output in HTML format.  
<br>eg http://localhost:8080/viewer/run?__report=myreport.rptdesign&parm1=value1
</p>
<p>
The <b>/preview</b> mapping runs and renders the report and does not generate a report document, although an existing report document can be used in which case just the render operation occurs.  The output from the run and render operation is sent directly to the browser.  
<br>eg http://localhost:8080/viewer/preview?__report=myreport.rptdesign&parm1=value1
</p>

<img src="servletmappings.PNG" /><br/><br/>

<h2><a name="webxml"></a>Web Viewer Web.xml Settings</h2>
<p>
...
<table border="1">
 ...
 <tr>
  ...
  <td>
  <p >This
  setting sets the default locale for the Web Viewer.</p>
  </td>
 </tr>
 <tr>
  <td>
  ...
  <td>
  <p >This
  is the default location for report designs.  If the report design specified
  in a URL parameter is relative, this path is pre-pended to the report name.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >If
  a report document parameter (__document) is not used, this is the location
  that report documents will be generated in.  If this setting is left blank,
  the default value “webapp/documents” will be used.  If the__document URL
  parameter is used and the value is relative the report document will be
  created in the working folder.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >If
  this value is set to true, reports will only be searched for, relative to the
  working folder.  This prevents a user from entering a full path to a report. 
  Relative paths below the working folder are accessible.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >Specifies
  the default location to store temporary images generated by the report
  engine.  If this setting is left blank, the default location of
  webapp/report/images is used.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >Specifies
  the default location to store report engine log files.  If this setting is
  left blank, the default location of webapp/logs is used.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >Sets
  the report engine log level.  Valid values are:
  <br>OFF
  <br>SEVERE
  <br>WARNING
  <br>INFO
 ...
 <tr>
  ...
  >
  <p >Specifies
  the default location to place Jar files used by the script engine.  These can
  be Jars used by script engine or jars containing event handlers written in
  Java.  These Jars are appended to the classpath.  If this setting is left
  blank the default value of webapp/scriptlib will be used.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >This
  setting specifies the resource path used by report engine.  The resource path
  is used to search for libraries, images, and properties files used by a
  report.  If this setting is left blank, resources will be searched for in the
  same directory as the report.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >Specifies
  the maximum number of rows to retrieve from a dataset.</p>
  </td>
 </tr>
 <tr>
  <td
  ...
  >
  <p >Specifies
  whether to overwrite the report document every time a report is executed. 
  The default is set to true.  Valid values are true and false.</p>
  </td>
 </tr>
 <tr>
  <td
